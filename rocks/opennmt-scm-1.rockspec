...
build = {
  ...
  modules = {
    ...
    ["onmt.modules.ContextGateAttention"] = "onmt/modules/ContextGateAttention.lua",
    ["onmt.modules.Coverage.ContextCoverage"] = "onmt/modules/Coverage/ContextCoverage.lua",
    ["onmt.modules.Coverage.CoverageAttention"] = "onmt/modules/Coverage/CoverageAttention.lua",
    ["onmt.modules.Utils.Energy"] = "onmt/modules/Utils/Energy.lua",
    ["onmt.modules.Utils.SequenceLinear"] = "onmt/modules/Utils/SequenceLinear.lua",
    ["onmt.modules.Utils.Replicator"] = "onmt/modules/Utils/Replicator.lua",
    ["onmt.modules.Utils.LayerNormalization"] = "onmt/modules/Utils/LayerNormalization.lua",
    ["onmt.modules.Reinforce.BaselineRewarder"] = "onmt/modules/Reinforce/BaselineRewarder.lua",
    ["onmt.modules.Reinforce.ClassNLLCriterionWeighted"] = "onmt/modules/Reinforce/ClassNLLCriterionWeighted.lua",
    ["onmt.modules.Reinforce.LinearNoBackpropInput"] = "onmt/modules/Reinforce/LinearNoBackpropInput.lua",
    ["onmt.modules.Reinforce.MultinomialSample"] = "onmt/modules/Reinforce/MultinomialSample.lua",
    ["onmt.modules.Reinforce.ParallelClassNLLCriterionWeighted"] = "onmt/modules/Reinforce/ParallelClassNLLCriterionWeighted.lua",
    ["onmt.modules.Reinforce.RecurrentBaselineRewarder"] = "onmt/modules/Reinforce/RecurrentBaselineRewarder.lua",
    ["onmt.modules.Reinforce.ReinforceCriterion"] = "onmt/modules/Reinforce/ReinforceCriterion.lua",
