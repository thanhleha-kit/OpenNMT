...
function DecoderAdvancer:initBeam()
  ...
  local decOutputs = {}
  local state = { self.decStates, decOutputs, self.context, nil, features, sourceSizes, 1 }
...
function DecoderAdvancer:update(beam)
  ...
  local decStates, decOutputs, context, _, features, sourceSizes, t
  ...
  decOutputs, decStates = self.decoder:forwardOne(inputs, decStates, context, decOutputs)
  t = t + 1
  local softmaxOut = self.decoder.softmaxAttn.output
  local nextState = {decStates, decOutputs, context, softmaxOut, nil, sourceSizes, t}
