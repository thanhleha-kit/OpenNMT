...
--]]
function DecoderAdvancer:__init(decoder, batch, context, max_sent_length, max_num_unks, decStates, dicts, word_pen)
...
function DecoderAdvancer:initBeam()
  ...
  -- Define state to be { decoder states, decoder outputs, context,
  -- attentions, features, sourceSizes, step }.
  local decOutputs = {}
  local state = { self.decStates, self.sourceMask, decOutputs, self.context, nil, features, sourceSizes, 1 }
...
function DecoderAdvancer:update(beam)
  ...
  local decStates, sourceMask, decOutputs, context, _, features, sourceSizes, t
  ...
  decOutputs, decStates = self.decoder:forwardOne(inputs, sourceMask, decStates, context, decOutputs)
  t = t + 1
  local softmaxOut = self.decoder.softmaxAttn.output 
  --~ local softmaxOut = nil
  local nextState = {decStates, sourceMask, decOutputs, context, softmaxOut, nil, sourceSizes, t}
